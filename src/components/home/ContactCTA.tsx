...
function RotatingCapability() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      >
        <cap.icon size={12} className="text-white sm:!w-[13px] sm:!h-[13px]" />
      </div>
    ...
    <section ref={sectionRef} className="section-padding relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10 py-10 sm:py-14 md:py-20 px-5 sm:px-6 md:px-12 lg:px-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <motion.div
                  ...
                  className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1 sm:py-1.5 rounded-full bg-white/10 text-white text-[11px] sm:text-xs font-medium mb-4 sm:mb-6 backdrop-blur-sm"
                >
                  <Sparkles size={11} className="sm:!w-[12px] sm:!h-[12px]" />
                  LaunchFive Studio
                </motion.div>
                ...
                <motion.h2
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-3 sm:mb-4"
                >
                ...
                <motion.p
                  ...
                  className="text-white/60 text-xs sm:text-sm md:text-base max-w-md mx-auto lg:mx-0 mb-6 sm:mb-8 leading-relaxed"
                >
                ...
                >
                  <CTAButton
                    href="#contact"
                    size="lg"
                    className="bg-white text-[#7C3AED] hover:shadow-xl hover:shadow-black/20 w-full sm:w-auto justify-center"
                  >
                  ...
                  <CTAButton
                    variant="secondary"
                    size="lg"
                    className="bg-white/10 text-white hover:bg-white/20 border-white/20 w-full sm:w-auto justify-center"
                  >
                    View Our Work
                  </CTAButton>
                </motion.div>
              ...
              >
                ...
                <motion.p
                  ...
                  className="text-white/40 text-[10px] sm:text-xs font-semibold uppercase tracking-widest mb-2 text-center lg:text-left"
                >
                  What We Build
                </motion.p>
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  {capabilities.map((cap, i) => (
                    <motion.div
                      ...
                      className="flex items-center gap-2 sm:gap-3 p-2.5 sm:p-3.5 rounded-xl bg-white/[0.08] backdrop-blur-sm border border-white/[0.1] hover:border-white/[0.2] transition-all cursor-default"
                    >
                      <div
                      ...
                      >
                        <cap.icon size={13} className="text-white sm:!w-[16px] sm:!h-[16px]" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-white text-[11px] sm:text-sm font-medium leading-tight truncate">
                          {cap.label}
                        </p>
                        <p className="text-white/40 text-[8px] sm:text-[10px] hidden sm:block">
                ...
                <motion.div
                  ...
                  className="flex items-center justify-center lg:justify-start gap-2 sm:gap-3 pt-1 sm:pt-2"
                >
