...
export default function TeamPreview() {
  return (
    <section id="team" className="section-padding relative overflow-hidden bg-section-light-bg text-section-light-foreground">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-primary/[0.05] rounded-full blur-[150px] pointer-events-none" />
        ...
        <RevealGroup className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
          {teamMembers.map((member, i) => (
            <Reveal
              ...
              duration={0.6}
              delay={i * 0.1}
              className={`group relative rounded-2xl bg-section-light-card border border-section-light-border p-5 sm:p-6 text-center hover:border-primary/30 transition-all duration-300 overflow-hidden h-full ${
