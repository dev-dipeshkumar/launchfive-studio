...
export const teamMembers: TeamMember[] = [
  {
    ...
    bio: "Builds responsive web apps, dashboards, backend logic, and deployment-ready web experiences. Arjun specializes in React, Next.js, and Node.js, delivering clean architecture and maintainable code across full-stack projects.",
  ...
  },
  {
    ...
    bio: "Works on mobile app interfaces, user flows, Firebase integrations, and cross-platform app structures. Priya builds with React Native and Flutter, creating app experiences that are smooth, functional, and platform-ready.",
  ...
  },
  {
    ...
    bio: "Designs clean user journeys, wireframes, prototypes, and product interfaces focused on clarity. Kabir creates design systems and interaction patterns that make digital products intuitive and visually coherent.",
  ...
  },
  {
    ...
    bio: "Creates brand visuals, social media designs, templates, banners, and digital creative assets. Sara works across Illustrator, Photoshop, and InDesign to produce consistent, on-brand graphics for digital and print platforms.",
  ...
  },
  {
    ...
    bio: "Designs campaign visuals, ad creatives, launch graphics, and promotional content for digital platforms. Rohan creates attention-focused creatives sized and styled for social, display, and paid media channels.",
